            ...
            <div className="container-fluid">
                <div className="row justify-content-center">
                    <div className="col-12 col-sm-10 col-md-8 col-lg-7 justify-content-center">
                        ...
                        <div className="w-100 p-5 row bg1 justify-content-center m-auto" style={{borderRadius:"25px"}}>
                            ...
                            <a href="/salas" className="a d-inline col-12 col-sm-7 col-md-5 col-lg-4  my-5" id="entrarSalas"><img src={botao}className="w-100 hover" alt=""/></a>
                        </div>
                    </div>
                </div>
            </div>
