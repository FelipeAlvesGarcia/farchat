        ...
        <>
                ...
                <div className="row justify-content-center">
                    <div className="col-7 justify-content-center">
                        ...
                        <div className="w-100 p-5 row bg1 justify-content-center" style={{borderRadius:"25px"}}>
                            ...
                            <a href="/mensagens" className="a d-inline col-4 my-5"><img src={botao} className="w-100 hover" alt=""/></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <header className="bg1">
                <div className="container-fluid">
                    <div className="row">
                        <h1 className="ps-4 col-6"><a href="/sobre" className="a ms-2 hover2" id="titulo2">FARCHAT</a></h1>
                        <div className="col-6 justify-content-end d-flex align-items-center">
                            <a href="/"><img src={sair} style={{width:"1.5rem", height:"1.5rem"}} className="me-4 hover2" alt=""/></a>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main id="salas">
                <div className="container mt-5">
                    <a className="row bg2 rounded a my-2" id="sala" href="/mensagens">
                        <div className="col-6">
                    ...
                    <div className="row position-relative bg2 rounded a my-2 privada" id="sala" onClick={sala}>
                        <div className="col-6">
